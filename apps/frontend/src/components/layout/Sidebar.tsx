  ...
  return (
    <>
      ...
      <aside
        id="sidebar"
        className={cn(
          "fixed top-0 bottom-0 left-0 z-50 w-72 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-lg transition-transform duration-300 md:shadow-none",
